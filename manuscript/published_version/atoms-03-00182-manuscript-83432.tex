...
\documentclass[atoms,article,accept,moreauthors,pdftex,12pt,a4paper]{mdpi}
%--------------------
% Class Options:
%--------------------
% journal
...
\doinum{10.3390/atoms3020182}
\pubvolume{3}
\pubyear{2015}
%\externaleditor{Academic Editor: Jonathan Goldwin  and Duncan O'Dell }
\history{Received: 7 April 2015  / Accepted: 18 May 2015  / Published: 26 May 2015}
%------------------------------------------------------------------
...
\address{%
$^{1}$ Department of Physics and Astronomy, Rice Quantum Institute, Rice University, Houston, \linebreak TX 77251-1892, USA; {E-Mails}: phydonglin@gmail.com (L.D.); ricezhuchzh@gmail.com (C.Z.) \\
$^{2}$ Center for Cold Atom Physics, Chinese Academy of Sciences, Wuhan 430071, China
\vspace{-12pt}}


% Contact information of the corresponding author (Add [2] after \corres if there are more than one corresponding author.)
\corres{E-Mail: hpu@rice.edu.}
...
\academiceditor{{Jonathan Goldwin  and Duncan O'Dell}}
...
To solve the Master Equation (\ref{masterEq}), we choose our basis states as direct product states of photon Fock state $|n \rangle$ and atomic internal state $|\upsigma=\uparrow,\downarrow \rangle$: $|n;\upsigma\rangle \equiv |n \rangle \otimes |\upsigma \rangle$, %$n=0,1,2,...,\infty$
...
\makeatother
\begin{thebibliography}{----} % if there are less than 10 entries, enter a one digit number
\bibitem{JCM}
...
\bibitem{cavity0}Ye, J.; Vernooy, D.W.; Kimble, H.J. Trapping of single atoms in cavity QED. {\em Phys. Rev. Lett.} {\bf 1999}, {\em 83}, 4987--4990.
\bibitem{cavity1}
...
\bibitem{cavity3}
Slama, S.; Bux, S.; Krenz, G.; Zimmermann, C.; Courteille, P.H.W. Superradiant Rayleigh \scalebox{0.98}{Scattering and Collective Atomic Recoil Lasing in a Ring Cavity. {\em Phys. Rev. Lett.} {\bf 2007}, {\em 98}, 053603.}
\begin{comment}
\bibitem{cavity4}
...
\bibitem{mixing1} Yuan, J.; Feng, W.; Li, P.; Zhang, X.; Zhang, Y.; Zheng, H.; Zhang, Y. Controllable vacuum Rabi splitting and optical bistability of multi-wave-mixing signal inside a ring cavity. {\em Phys. Rev. A} {\bf 2012}, {\em 86}, 063820.
\bibitem{mixing2} Chen, H.; Zhang, Y.; Yao, X.; Wu, Z.; Zhang, X.; Zhang, Y.; Xiao, M. Parametrically Amplified Bright-state Polariton of Four- and Six-wave Mixing in an Optical Ring Cavity. {\em Sci. Rep.} {\bf 2014},\linebreak {\em 4}, 3619.
\bibitem{soc1}
...
\bibitem{MF}
Sau, J.D.; Lutchyn, R.M.; Tewari, S.; Sarma Das, S. Generic New Platform for Topological \scalebox{0.98}{Quantum Computation Using Semiconductor Heterostructures. {\em Phys. Rev. Lett.} {\bf 2010}, {\em 104}, 040502.}
\bibitem{WF}
...
\bibitem{csoc4}
Mivehvar, F.; Feder, D. \emph{Enhanced Stripe Phases in Spin-Orbit-Coupled Bose-Einstein Condensates in Ring Cavities}; Cornell University Library:  Ithaca, NY, USA,  2015.%{\bf 2015} arXiv: 1505.02189
\bibitem{L1}
